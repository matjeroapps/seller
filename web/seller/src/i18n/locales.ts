...
export const messages: Record<Locale, Record<string, string>> = {
  ar: {
    ...
    // Domain Management
    domainsNav: 'نطاقات المتجر',
    storefrontDomainsTitle: 'نطاقات واجهة المتجر',
    platformDomainSection: 'نطاق المنصة الرئيسي',
    customDomainsSection: 'النطاقات المخصصة',
    addCustomDomain: 'إضافة نطاق مخصص',
    domainInputLabel: 'اسم النطاق المخصص',
    domainInputPlaceholder: 'مثال: shop.example.com',
    domainInputHelp: 'أدخل اسم المضيف فقط، بدون https:// أو الفواصل.',
    requestDomain: 'طلب إضافة النطاق',
    requesting: 'جاري إرسال الطلب...',
    dnsInstructionsTitle: 'إعدادات سجل التحقق DNS TXT',
    dnsInstructionsHelp: 'للتحقق من ملكية هذا النطاق، يرجى إضافة سجل TXT التالي لدى مزود خدمة DNS لديك:',
    recordType: 'نوع السجل',
    recordName: 'اسم السجل',
    recordValue: 'قيمة السجل',
    copy: 'نسخ',
    copied: 'تم النسخ!',
    checkVerification: 'فحص التحقق',
    verifying: 'جاري الفحص...',
    activateDomain: 'تفعيل النطاق',
    activating: 'جاري التفعيل...',
    statusPending: 'قيد التحقق',
    statusVerified: 'تم التحقق (غير مفعل)',
    statusActive: 'نشط',
    statusFailed: 'فشل التحقق',
    statusDisabled: 'معطل من الإدارة',
    primaryDomain: 'النطاق الأساسي',
    secondaryDomain: 'نطاق ثانوي',
    verificationFailedNotice: 'سجل TXT غير موجود أو غير متطابق بعد. يرجى التأكد من إعدادات DNS ثم النقر على فحص التحقق مجدداً.',
    verificationServiceUnavailable: 'خدمة فحص التحقق غير متاحة مؤقتاً. يرجى المحاولة لاحقاً.',
    disabledNotice: 'تم تعطيل هذا النطاق من قبل إدارة المنصة ويتطلب مراجعة إدارية.',
    activateConfirmTitle: 'تأكيد تفعيل النطاق الأساسي',
    activateConfirmMessage: 'سيصبح هذا النطاق المخصص هو النطاق الأساسي لمتجرك. سيبقى نطاق منصة متجرو متاحاً كنطاق ثانوي نشط.',
    confirmActivate: 'تفعيل كـ أساسي',
    currentStorefrontHost: 'عنوان المتجر المباشر الحالي',
    noDomainsFound: 'لا توجد نطاقات مخصصة مسجلة لهذا المتجر.',
    loadingDomains: 'جاري تحميل نطاقات المتجر...',
    domainTypePlatform: 'نطاق منصة',
    domainTypeCustom: 'نطاق مخصص'
  },
  en: {
    ...
    // Domain Management
    domainsNav: 'Store Domains',
    storefrontDomainsTitle: 'Storefront Domains',
    platformDomainSection: 'Platform Domain',
    customDomainsSection: 'Custom Domains',
    addCustomDomain: 'Add Custom Domain',
    domainInputLabel: 'Custom Domain Hostname',
    domainInputPlaceholder: 'e.g. shop.example.com',
    domainInputHelp: 'Enter the hostname only, without https:// or trailing slashes.',
    requestDomain: 'Request Custom Domain',
    requesting: 'Submitting request...',
    dnsInstructionsTitle: 'DNS TXT Verification Instructions',
    dnsInstructionsHelp: 'To prove domain ownership, add the following TXT record to your DNS provider:',
    ...
    statusVerified: 'Verified (Not Active)',
    statusActive: 'Active',
    statusFailed: 'Verification Failed',
    statusDisabled: 'Disabled by Admin',
    primaryDomain: 'Primary Domain',
    secondaryDomain: 'Secondary Domain',
    verificationFailedNotice: 'TXT record not found or not matching yet. Please verify your DNS settings and click Check Verification again.',
    verificationServiceUnavailable: 'Verification service is temporarily unavailable. Try again later.',
    disabledNotice: 'This domain was disabled by platform administration and requires administrative resolution.',
    activateConfirmTitle: 'Activate Custom Primary Domain',
    activateConfirmMessage: 'Activating this custom domain will set it as your store\'s primary storefront host. Your Matjero platform domain will remain available as an active secondary domain.',
    confirmActivate: 'Activate Primary',
    currentStorefrontHost: 'Current Live Storefront Host',
    noDomainsFound: 'No custom domains registered for this store.',
    loadingDomains: 'Loading store domains...',
    domainTypePlatform: 'Platform Domain',
    domainTypeCustom: 'Custom Domain'
  }
};
